...
* Send form as MSG
* Stage form in JS8Call Status field or use JS8Spotter
* The same form is used and static all wwek (5 days)
* Query Net member forms by using STATUS? use JS8Spotter query (e.g. @NET STATUS? and @NET E? F!NET)
